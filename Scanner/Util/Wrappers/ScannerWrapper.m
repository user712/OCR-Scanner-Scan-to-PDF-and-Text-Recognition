...
#import "ScannerWrapper.h"

@implementation ScannerWrapper
...
//-(void)drawPageNbr:(int)pageNumber font: (UIFont *) textFont{
//    NSString *setPageNum = [NSString stringWithFormat:@"Page %d", pageNumber];
////    UIFont *pageNbrFont = [UIFont systemFontOfSize:11];
//    
...
//    
////    CGSize pageStringSize = [setPageNum boundingRectWithSize:maxSize
////                                                     options:0
////                                                  attributes:attributes context:nil];
//    
//    CGRect pageStringSize = [setPageNum boundingRectWithSize: maxSize options: NSStringDrawingUsesLineFragmentOrigin| NSStringDrawingUsesFontLeading attributes:attributes context:nil];
//    
...
//    [setPageNum drawInRect:stringRect withAttributes:attributes];
//}
