...
struct ThemeManager {
    ...
    fileprivate static let SelectedThemeKey = "SelectedTheme"
}
...
extension ThemeManager {
    ...
    static func currentTheme() -> Theme {
        if let storedTheme = (UserDefaults.standard.value(forKey: ThemeManager.SelectedThemeKey) as AnyObject) as? NSNumber {
    ...
    static func applyTheme(_ theme: Theme) {
        ...
        UINavigationBar.appearance().backIndicatorImage = UIImage(named: "icBack")
