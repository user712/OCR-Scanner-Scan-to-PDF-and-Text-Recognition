...
class AlertManagerController: UIViewController {
    ...
    var strongSelf: AlertManagerController?
    ...
    private func resizeAndRelayout() {
        ...
        for i in 0 ..< buttons.count {
            ...
            buttons[i].addTarget(self, action: #selector(pressed(sender:)), for: UIControlEvents.touchUpInside)
        }
    ...
    func closeAlert(buttonIndex:Int){
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, options: UIViewAnimationOptions.curveEaseOut, animations: { [unowned self] () -> Void in
            self.view.alpha = 0.0
        }) { (Bool) -> Void in
    ...
    func showAlert(title: String) -> AlertManagerController {
        _ = self.showAlert(title: title, subTitle: nil, style: .none)
        return self
    }
    
    func showAlert(title: String, subTitle: String?, style: AlertStyle) -> AlertManagerController {
        _ = self.showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: "OK".localized())
        return self
    }
    
    func showAlert(title: String, subTitle: String?, style: AlertStyle, buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> AlertManagerController {
        _ = self.showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: UIColor.colorFromRGB(rgbValue: 0xAEDEF4))
        userAction = action
        return self
    }
    ...
    public func showAlertOnCreationFolder(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) -> AlertManagerController {
        
        return self
    }
    
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) -> AlertManagerController {
        _ = self.showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: buttonColor, otherButtonTitle: nil)
        userAction = action
        return self
    }
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,otherButtonTitle:
        String?, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> AlertManagerController {
        _ = self.showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: buttonColor, otherButtonTitle: otherButtonTitle, otherButtonColor: UIColor.red)
        userAction = action
        return self
    }
...
class CancelAnimatedView: AnimatableView {
    ...
    private var outlineCircle: CGPath  {
        ...
        path.addArc(withCenter: CGPoint(x: self.frame.size.width / 2.0, y: self.frame.size.width / 2.0),
