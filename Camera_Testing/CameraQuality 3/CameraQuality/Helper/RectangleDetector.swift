...
extension RectangleDetector {
    ...
    func drawRectangleLayer(inRect layer: CAShapeLayer, previewRect: CGRect, ciImage: CIImage, biggestRectangleFeature: CIRectangleFeature) {
    ...
    func captureManagerDidOutput(_ sampleBuffer: CMSampleBuffer, rectangleLayer: CAShapeLayer, superView: UIView) {
        ...
        if let pixelBuffer = CMSampleBufferGetImageBuffer(sampleBuffer) {
            ...
            if let lastRectFeature = self.borderDetectLastRectangleFeature {
                self.drawRectangleLayer(inRect: rectangleLayer, previewRect: superView.frame, ciImage: ciImage, biggestRectangleFeature: lastRectFeature)
